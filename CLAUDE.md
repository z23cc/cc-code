...
- `skills/` — 78 skills (all prefixed `cc-`):
  ...
  - **Chains:** 39 predefined workflows in `chains.json` (idea-to-ship, feature, bugfix, hotfix, qa-fix, incident, security-audit, performance, deploy, testing, async-backend, db-migration, prd-to-ship, clone-and-ship, etc.)
