...
SKILL_CHAINS = {
    "feature": {
        ...
        "skills": [
            ...
            {"skill": "/cc-requirement-gate", "role": "Validate requirements (clarity, completeness, risks)", "required": False,
            ...
            {"skill": "/cc-review", "role": "Code review (severity-weighted consensus)", "required": True,
             "reads": ["files_changed"], "outputs": ["verdict", "issues_fixed", "severity_summary", "lens"]},
    ...
    "idea-to-ship": {
        ...
        "skills": [
            ...
            {"skill": "/cc-requirement-gate", "role": "Validate requirements before planning", "required": False},
