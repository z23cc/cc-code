...
description: "Dependency upgrade workflow — audit, plan, upgrade, test, fix breaking changes. Supports Python/JS/Go/Rust. TRIGGER: 'upgrade dependencies', 'update packages', 'bump versions', 'security vulnerability', 'outdated', '升级依赖', '更新包', '版本升级'. NOT FOR: new dependency selection (use research), code refactoring (use cc-simplify). FLOWS INTO: cc-verification, cc-review."
---
...
- **cc-readiness-audit** — Pillar 7 checks for vulnerable dependencies
- **cc-autoimmune** — Mode B can auto-fix lint/type issues after upgrades
- **cc-verification** — verify each upgrade step before committing
