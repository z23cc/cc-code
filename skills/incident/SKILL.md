...
- **debugging** — systematic root cause investigation (Phase 1-4)
- **logging** — structured logs for incident investigation
- **deploy** — rollback and hotfix patterns
- **readiness-audit** — Pillar 6 (observability) prevents incidents
