...
- **git-workflow** — conventional commits feed CHANGELOG
- **scaffold** — initial docs generated during project setup
- **readiness-audit** — Pillar 4 checks documentation completeness
