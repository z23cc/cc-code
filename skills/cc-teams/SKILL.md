...
- **cc-worker-protocol** — per-task worker isolation
- **cc-code-review-loop** — review verdict gates (SHIP/NEEDS_WORK/MAJOR_RETHINK)
- **cc-autoimmune** — autonomous improvement with team support
- **cc-feedback-loop** — record team outcomes for routing improvement
