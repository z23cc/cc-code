...
- **async-patterns** — when to use asyncio vs Celery
- **deploy** — Docker setup for workers + beat + flower
- **error-handling** — retry strategies and circuit breakers
- **performance** — profiling slow tasks, optimizing throughput
- **logging** — structured logging in distributed workers
